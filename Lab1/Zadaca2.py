...
def turni_topka_gore(x, y, manX, manY, protivnik1, protivnik2):
    if 0 < y-1 < 6 and (x != manX and y-1 != manY) and (x != protivnik1[0] and y-1!= protivnik1[1]) and (x != protivnik2[0] and y-1 != protivnik2[1]) and (x  < protivnik2[0]-1 and y-1 > protivnik2[1]+1) and (x < protivnik1[0]-1 and y-1 > protivnik1[1]+1)   and  (x  > protivnik2[0]+1 and y-1 < protivnik2[1]-1) and (x > protivnik1[0]+1 and y-1 < protivnik1[1]-1):
        y-=1
    return x,y
    
def turni_topka_dolu(x, y, manX, manY, protivnik1, protivnik2):
    if 0 < y+1 < 6 and (x != manX and y+1 != manY) and\
    (x != protivnik1[0] and y+1 != protivnik1[1]) and\
        (x != protivnik2[0] and y+1 != protivnik2[1]) and\
            (x  < protivnik2[0]-1 and y+1 > protivnik2[1]+1) and \
                (x < protivnik1[0]-1 and y+1 > protivnik1[1]+1)   and\
                    (x  > protivnik2[0]+1 and y+1 < protivnik2[1]-1) and\
                        (x > protivnik1[0]+1 and y+1 < protivnik1[1]-1):
        y+=1
    return x,y

def turni_topka_desno(x, y, manX, manY, protivnik1, protivnik2):
    if 0 < x+1 < 6 and (x+1 != manX and y != manY) and\
        (x+1 != protivnik1[0] and y != protivnik1[1]) and\
            (x+1 != protivnik2[0] and y != protivnik2[1]) and \
                (x+1  < protivnik2[0]-1 and y > protivnik2[1]+1) and\
                    (x+1 < protivnik1[0]-1 and y > protivnik1[1]+1)   and \
                        (x+1  > protivnik2[0]+1 and y < protivnik2[1]-1) and \
                            (x+1 > protivnik1[0]+1 and y < protivnik1[1]-1):
        x+=1
    return x,y

def turni_topka_gore_desno(x, y, manX, manY, protivnik1, protivnik2):
    if 0 < y-1 < 6 and 0 < x+1 < 8 and (x+1 != manX and y-1 != manY) and\
        (x+1 != protivnik1[0] and y-1 != protivnik1[1]) and\
            (x+1 != protivnik2[0] and y-1 != protivnik2[1]) and\
                (x+1  < protivnik2[0]-1 and y-1 > protivnik2[1]+1) and \
                    (x+1 < protivnik1[0]-1 and y-1 > protivnik1[1]+1)   and\
                        (x+1  > protivnik2[0]+1 and y-1 < protivnik2[1]-1) and \
                            (x+1 > protivnik1[0]+1 and y-1 < protivnik1[1]-1):
        y-=1
        x+=1
    return x,y

def turni_topka_dolu_desno(x, y, manX, manY, protivnik1, protivnik2):
    if 0 < y+1 < 6 and 0 < x+1 < 8 and\
        (x+1 != manX and y+1 != manY) and\
            (x+1 != protivnik1[0] and y+1 != protivnik1[1]) and\
             (x+1 != protivnik2[0] and y+1 != protivnik2[1]) and\
                (x+1  < protivnik2[0]-1 and y+1 > protivnik2[1]+1) and\
                    (x+1 < protivnik1[0]-1 and y+1 > protivnik1[1]+1)   and\
...
def pomesti_coveche_gore(x, y, ballX, ballY, protivnik1, protivnik2):
    if 0 < y-1 < 6 and (x != ballX and y-1 != ballY) and (x != protivnik1[0] and y-1 != protivnik1[1]) and (x != protivnik2[0] and y-1 != protivnik2[1]):
        y-=1
    elif 0 < y-1 < 6 and (x == ballX and y-1 == ballY):
        turni_topka_gore(ballX, ballY, x,y, protivnik1, protivnik2)
        y-=1
def pomesti_coveche_dolu(x, y, ballX, ballY, protivnik1, protivnik2):
    if 0 < y+1 < 6 and (x != ballX and y+1 != ballY) and (x != protivnik1[0] and y+1 != protivnik1[1]) and (x != protivnik2[0] and y+1 != protivnik2[1]):
        y+=1
    elif 0 < y+1 < 6 and (x == ballX and y+1 == ballY):
        y+=1
        turni_topka_dolu(ballX, ballY, x,y, protivnik1, protivnik2)

def pomesti_coveche_desno(x, y, ballX, ballY, protivnik1, protivnik2):
    if 0 < y-1 < 6 and (x != ballX and y-1 != ballY) and (x != protivnik1[0] and y-1 != protivnik1[1]) and (x != protivnik2[0] and y-1 != protivnik2[1]):
        y-=1
    elif 0 < y-1 < 6 and (x == ballX and y-1 == ballY):
        turni_topka_gore(ballX, ballY, x,y, protivnik1, protivnik2)

def pomesti_coveche_gore_desno(x, y, ballX, ballY, protivnik1, protivnik2):
    if 0 < y-1 < 6 and (x != ballX and y-1 != ballY) and (x != protivnik1[0] and y-1 != protivnik1[1]) and (x != protivnik2[0] and y-1 != protivnik2[1]):
        y-=1
    elif 0 < y-1 < 6 and (x == ballX and y-1 == ballY):
        turni_topka_gore(ballX, ballY, x,y, protivnik1, protivnik2)

def pomesti_coveche_dolu_desno(x, y, ballX, ballY, protivnik1, protivnik2):
    if 0 < y-1 < 6 and (x != ballX and y-1 != ballY) and (x != protivnik1[0] and y-1 != protivnik1[1]) and (x != protivnik2[0] and y-1 != protivnik2[1]):
        y-=1
    elif 0 < y-1 < 6 and (x == ballX and y-1 == ballY):
        turni_topka_gore(ballX, ballY, x,y, protivnik1, protivnik2)
...
class Football(Problem):
    ...
    def check_valid(state, opponents):
        ...
        return man_pos[0] >= 0 and man_pos[0] < 8 and \
                ...
                man_pos[0] != protivnik1[0] and man_pos[1] != protivnik1[1] and\
                man_pos[0] != protivnik2[0] and man_pos[1] != protivnik2[1] and \
                ball_pos[0] != protivnik1[0] and ball_pos[1] != protivnik1[1] and\
                ball_pos[0] != protivnik2[0] and ball_pos[1] != protivnik2[1]
...
if __name__ == '__main__':
    ...
    football = Football((man_pos[0], man_pos[1], ball_pos[0], ball_pos[1]), goal=goal_position)
